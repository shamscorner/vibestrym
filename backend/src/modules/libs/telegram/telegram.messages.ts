...
export const MESSAGES = {
	welcome:
		`<b>👋 Hey there! Welcome to BDLive Bot!</b>\n\n` +
	...
	authSuccess: `🥳 Woohoo! You've successfully connected your Telegram account with BDLive!\n\n`,
	...
	follows: (user: User) =>
		`📱 <a href="https://bdlive.com/${user.username}">${user.username}</a>`,
	...
	deactivate: (token: string, metadata: SessionMetadata) =>
		...
		`Thanks for being part of <b>BDLive</b>! We'd love to see you stick around. 🚀\n\n` +
		`Cheers,\n` +
		`The BDLive Team`,

	accountDeleted:
		`<b>👋 Your account has been deleted</b>\n\n` +
		`We've completely removed your account from BDLive. All your data is gone for good. 🗑️\n\n` +
